...
import (
	...
	serversv1beta1 "cloudnativejp/api/v1beta1"
...
// +kubebuilder:rbac:groups=servers.cloudnativejp,resources=service,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=servers.cloudnativejp,resources=service/status,verbs=get;update;patch
...
func (r *WebServerReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	r.Log.V(1).Info("VAR", "Reconciler", r)
	r.Log.V(1).Info("VAR", "INSTANCE", instance)
	r.Log.V(1).Info("VAR", "SCHEME", r.scheme)
